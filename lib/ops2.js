(function() {
  ...
  globalThis.draw_line_boxes = function(nodes = null) {
    var i, len, linefinder, node, rectangle, rectangles, ref, ref_top;
    if (nodes == null) {
  ...
  µ.DOM.ready(function() {
    var aligner, button, first_tracker, galley_document, galley_iframe, galley_window, i, iframe, iframes, j, len, len1, ref, sub_document;
    log('^123-7^', "ready");
    ...
    for (j = 0, len1 = iframes.length; j < len1; j++) {
      iframe = iframes[j];
