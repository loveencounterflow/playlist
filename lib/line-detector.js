(function() {
  ...
  var _get_next_chr_rectangles, _reset_line_walker, after, debug, draw_box, draw_boxes, log, remove_boxes, walk_chr_rectangles_of_node, walk_line_rectangles_of_node, warn;
  ...
  µ.DOM.ready(function() {
    var dt, i, idx, len, node, nodes, rectangle, rectangles, ref, ref_top, scroll;
    log('^123-7^', "ready");
